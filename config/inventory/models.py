...
class StoreBranding(models.Model):
    ...
    legal_contact_email = models.EmailField(blank=True, default="")
    legal_contact_phone = models.CharField(max_length=40, blank=True, default="")
    legal_contact_address = models.CharField(max_length=220, blank=True, default="")
    legal_contact_city = models.CharField(max_length=80, blank=True, default="")
    legal_contact_department = models.CharField(max_length=80, blank=True, default="")
    promo_top_enabled = models.BooleanField(default=False)
    promo_top_title = models.CharField(max_length=120, blank=True, default="")
    promo_top_text = models.CharField(max_length=260, blank=True, default="")
    promo_top_image_desktop_url = models.URLField(blank=True, default="")
    promo_top_image_mobile_url = models.URLField(blank=True, default="")
...
class ShipmentEvent(models.Model):
    """
    Eventos del webhook para un envío.
    """
