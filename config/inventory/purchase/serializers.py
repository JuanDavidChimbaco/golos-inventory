...
from ..models import MovementInventory, Supplier
...
class PurchaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MovementInventory
        fields = [
            'id', 'variant', 'supplier', 'supplier_name', 'supplier_nit',
            'product_name', 'product_brand', 'variant_info', 'movement_type',
            'movement_type_display', 'quantity', 'observation', 'created_at', 'created_by'
        ]
