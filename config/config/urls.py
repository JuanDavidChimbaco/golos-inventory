...
from inventory.store.views import (
    ...
    StoreLocationsDepartmentsView,
    StoreLocationsCitiesView,
    StorePickupPointsView,
...
urlpatterns = [
    ...
    path("api/store/shipping/quote/", StoreShippingQuoteView.as_view(), name="store-shipping-quote"),
    path("api/store/locations/departments/", StoreLocationsDepartmentsView.as_view(), name="store-locations-departments"),
    path("api/store/locations/departments/<str:department_code>/cities/", StoreLocationsCitiesView.as_view(), name="store-locations-cities"),
    path("api/store/pickup-points/", StorePickupPointsView.as_view(), name="store-pickup-points"),
